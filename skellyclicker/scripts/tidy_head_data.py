...
if __name__=='__main__':
    labels_path = Path("/home/scholl-lab/ferret_recordings/session_2025-06-29_ferret_757_EyeCameras_P31_EO3/full_recording/mocap_data/dlc_output/toy_model_v2/skellyclicker_machine_labels_iteration_9.csv")
    timestamps_path = Path("/home/scholl-lab/ferret_recordings/session_2025-06-29_ferret_757_EyeCameras_P31_EO3/full_recording/mocap_data/synchronized_corrected_videos")
    ...
    data.to_csv("/home/scholl-lab/ferret_recordings/session_2025-06-29_ferret_757_EyeCameras_P31_EO3/full_recording/mocap_data/toy_2d_tidy.csv", index=False)