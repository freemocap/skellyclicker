...
if __name__=='__main__':
    labels_path = Path("/home/scholl-lab/deeplabcut_data/pupil_tracking_ferret_757_EyeCameras_P43_E15__1/model_outputs/model_outputs_iteration_2/skellyclicker_machine_labels_iteration_2.csv")
    ...
    output_path = video_folder.parent / "dlc_annotated_videos"
    ...
    annotator_config = ImageAnnotatorConfig(
        show_names=False, tracked_points=sorted(data_handler.tracked_points), show_clicks=False, show_help=False
    )
