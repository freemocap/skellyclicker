...
from skellyclicker.core.video_handler.old_video_models import VideoPlaybackObject, VideoGridHelper, VideoGridScalingParameters
...
class VideoHandler(BaseModel):
    ...
    def launch_video_thread(self):
        self.video_thread = threading.Thread(target=self.skellyclicker.run)
